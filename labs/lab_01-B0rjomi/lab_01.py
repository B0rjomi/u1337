...
def _q_01():
    ...
    Traceback (most recent call last):
     File "/usr/lib/python3.8/doctest.py", line 1329, in __run
      ...
      File "<doctest __main__._q_01[8]>", line 1, in <module>
        x + y                                                   
...
def _q_03():
    ...
    Traceback (most recent call last):
      File "/usr/lib/python3.8/doctest.py", line 1329, in __run
        exec(compile(example.source, filename, "single",
      File "<doctest __main__._q_03[4]>", line 1, in <module>
    ...
    Traceback (most recent call last):
      File "/usr/lib/python3.8/doctest.py", line 1329, in __run
        exec(compile(example.source, filename, "single",
      File "<doctest __main__._q_03[12]>", line 1, in <module>
        1/0 or True                                             
    ZeroDivisionError: division by zero
