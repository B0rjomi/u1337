...
def make_withdraw(balance, password):
    ...
    """
    list_of_attempts = []
    def sub_withdraw(amount, attempts):
        nonlocal balance
        if len(list_of_attempts) == 3:
            return "Твой аккаунт заблокирован. Попытки входа: " + str(list_of_attempts)
